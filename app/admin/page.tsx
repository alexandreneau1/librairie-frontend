    ...
    <div style={{ backgroundColor: C.fond, minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{ backgroundColor: C.vert, paddingBottom: '60px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '60px 24px 0', boxSizing: 'border-box', textAlign: 'center' }}>
          ...
          <a href="/livres" style={{ display: 'inline-block', backgroundColor: C.or, color: 'white', padding: '14px 36px', borderRadius: '40px', fontWeight: '700', fontSize: '15px', textDecoration: 'none' }}>
